...
| `tools/gen_ic_footprints.py` | The same for the regulator, the IR emitter and the status LED. |
...
- **The USB-C receptacle.** The board carries KiCad's HCTL pattern. If the CUI
  UJ20 is what gets bought, that needs its own footprint.
